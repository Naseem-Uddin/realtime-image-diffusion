...
image = (modal.Image.debian_slim()
        ...
        "accelerate",
        "diffusers",
        "requests").run_function(download_model))
...
def keep_warm():
    health_url = "https://poleerridge--sd-demo-model-health.modal.run"
    generate_url = "https://poleerridge--sd-demo-model-generate.modal.run"
